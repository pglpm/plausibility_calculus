...
%% Last-Updated: 2020-07-13T23:01:46+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
literature. Bernard O. Koopman discussed the falsity of such claims in
1957. The introduction to his work \citep{koopman1957} is very explicit:
...
somewhat famous in the quantum community; although their focus was on the
alleged inconsistency of some properties of the Shannon entropy in quantum
theory.

The fallacy in their reasoning is the same as in Gelman \amp\ Yao, and
rests in an incorrect calculation of conditional probabilities. The errors
were shown by Porta Mana \citey{portamana2003_r2004} through a step-by-step
analysis and calculation. This work also showed, through simple examples
\parencite[\sect~IV]{portamana2003_r2004}, that the same incorrect
conclusions can be obtained with completely classical systems, such as
drawing from an urn, if the same incorrect way of computing conditional
