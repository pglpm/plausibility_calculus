...
%% Last-Updated: 2021-12-16T15:56:34+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\mynote{\wrench\ There are redundancies and repetitions to be fixed}
...
\item\label{item:utility_vs_inference} There is a utility part
  $u[y \| \theta(x)]$, and a clearly distinct inferential part
...
\item\label{item:px_needed} The optimization crucially depends on the
  ...
  requires an inference of probable future \emph{predictor} values. Current
