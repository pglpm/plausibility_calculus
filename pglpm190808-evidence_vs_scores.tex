...
%% Last-Updated: 2019-08-12T17:24:05+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
behind this score is more or less this: \enquote{let's see what my belief
...
which is the arithmetic mean on a log scale.

There is an ample literature discussing the properties and use of the
log-score \citep[for
...
Gelman \etal\ \citey{gelmanetal2014}, for example, show among other things
that it's approximately equal to expected value of the post-data
log-probability of a new datum:
\begin{equation}
  \label{eq:logscore_approx_logposterior}
  \E\condt[\Big]{\log\p(D' \| D\; H \; \yK)}{ D\; H \; \yK},
\end{equation}
where $D'$ represent the new datum. Krnjaji\'c \etal\
\citey{krnjajicetal2011,krnjajicetal2014} numerically compare it with the
deviance information criterion. Regarding its uses I recommend the recent,
beautiful debate in Gronau \etal\ \parentext{\cite*{gronauetal2019} \amp\
  \cite{chandramoulietal2019}}, where all authors give very
insightful remarks.
...
We can obviously write the likelihood as
\begin{equation}
