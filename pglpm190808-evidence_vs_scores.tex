...
%% Last-Updated: 2019-08-08T21:31:00+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\begin{equation}
  ...
  \begin{aligned}
    ...
    \bigl[\,&\p(D_{1} \| D_{-1} \, H \, \yK) \times
          ...
          &\underbracket[0pt][1ex]{\p(D_{d} \| D_{-d} \, H \, \yK)}_{
            \begin{smallmatrix}
  ...
  \end{aligned}
\end{equation}
Note that upon taking the logarithm of this expression, the factors
vertically aligned on the left turn together into the
...
log-scores for the three distinct subsets of data singletons $\set{D_{1}}$,
$\set{D_{2}}$, $\set{D_{3}}$.
...
+{}\\
  &\quad
    \begin{aligned}
\frac{1}{d\,(d-1)} \sum_{i\in\set{1,\dotsc,d}} \sum_{j\in\set{1,\dotsc,d}}^{j\ne i}  \ln\p(D_{-i,j} \| D_{-i,-j} \, H \, \yK)
  +  \dotsb +{}&\\[0.5\jot]
