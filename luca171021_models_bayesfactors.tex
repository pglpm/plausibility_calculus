...
%% Last-Updated: 2019-01-05T15:09:03+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\begin{abstract}\labelsep 0pt%
  \noindent Some notes or model comparison and selection, parameter
  estimation, Bayes factors, and so on.
...
models for our \dobs\ having this parametric form:
\begin{equation}
...
assumptions, $\yD$ data, and $\theta$ a parameter with values in some
manifold. This is a particular case of an exchangeable model
...
discussed in this literature. If we have several mutually exclusive and
exhaustive models $\yHm_1$, $\yHm_2$, \dots\ our \dob\ about each given
some data is
\begin{equation}
...
These issues suggest that we should re-examine what we're actually doing in
...
\begin{equation}
  ...
  \frac{\sum_j \pf(\yD, \yD' \| \yHm_j,\yI)\; \pf(\yHm_j \| \yI)}{
    \sum_k \pf(\yD' \| \yHm_k,\yI)\; \pf(\yHm_k \| \yI)},
\end{equation}
which can be suggestively \emph{rearranged} as follows, multiplying and
...
rather about possible data outcomes? Let's examine this question after
making an important distinction between two kinds of model.
...
Let's use this definition to explore the issues in model comparison and
parameter estimation previously discussed.
...
In concrete applications we usually seek \emph{non-learning} models. For
