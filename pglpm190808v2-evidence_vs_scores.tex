...
%% Last-Updated: 2020-05-19T01:14:48+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
A hypothesis $H$ is not well-defined, in a specific context $\yK$, unless
it and the context together fully determine the probability-values for all
the logical combinations of statements we want to infer from it. Let us
consider the case of statements of the form
$D_{d} \defd \prop{X_{d}\eq x_{d}}$, concerning the outcomes of several
measurements or observations $d \in \set{1,2,\dotsc}$. Thus every probability
such as
\begin{equation}
