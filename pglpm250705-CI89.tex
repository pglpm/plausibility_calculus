...
%% Last-Updated: 2025-07-05T21:29:23+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\propertitle}{The half uncertainty of 89\% credibility intervals%\\{\large ***}%
...
\noindent
\clap{AAAAA}\clap{\color{purple}\texttt{AAAAA}}
\\
\clap{OOOOO}\clap{\color{purple}\texttt{OOOOO}}
\\
\clap{TTTTT}\clap{\color{purple}\texttt{TTTTT}}
\\
\clap{aaaaa}\clap{\color{purple}\texttt{aaaaa}}
\\
\clap{\color{purple}\texttt{aaaaa}}\clap{aaaaa}
\\
\clap{ooooo}\clap{\color{purple}\texttt{ooooo}}
\\
\clap{\color{purple}\texttt{ooooo}}\clap{ooooo}
\\
\clap{ttttt}\clap{\color{purple}\texttt{ttttt}}
\\
\clap{ggggg}\clap{\color{purple}\texttt{ggggg}}
\\
\clap{00000}\clap{\color{purple}\texttt{00000}}
\\
\clap{88888}\clap{\color{purple}\texttt{88888}}
\\
\clap{11111}\clap{\color{purple}\texttt{11111}}
\\
\clap{22222}\clap{\color{purple}\texttt{22222}}
...
\begin{equation}
  \sum_{i} a_{i}
\end{equation}
 \autocites{riccietal1901,truesdell1963b_r1968,zahn1979_r2003,aizenmanetal1987,bossavit1999,coombsetal1954}

% \url{http://www.pdmi.ras.ru/%7Evershik/papers.html}

%  \autocites{opperetal2009,vershik2013}


${}^{4}\textrm{He}$

$\vphantom{\textrm{H}}^{4}\mkern-1mu\textrm{He}$
