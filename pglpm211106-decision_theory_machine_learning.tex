...
%% Last-Updated: 2021-11-16T15:16:28+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
{}\approx \argsup_{\theta} \iint u[y \| \theta(x)] \ 
      ...
      \di y\,\di x
    \\
{}\approx \argsup_{\theta} \sum_{\nu} u[\yyy{\nu} \| \theta(\xxx{\nu})] 
\end{multline}

According to this interpretation the loss function used in machine learning
does not represent the logarithm of our uncertainty or of the distribution
of noise, but the utility.
...
In modern \ml\ applications in particular field such as medicine this
