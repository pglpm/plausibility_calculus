...
%% Last-Updated: 2019-01-20T13:21:32+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\firstdraft}{19 January 2019}
\newcommand*{\firstpublished}{***}
\newcommand*{\propertitle}{Memos on factorial moments}
\newcommand*{\pdftitle}{\propertitle}
\newcommand*{\headtitle}{Factorial moments}
...
\begin{abstract}\labelsep 0pt%
  \noindent Memos on factorial moments.
...
Consider a quantity $x$ assuming integer values $\set{0,1,\dotsc,N}$, and a
distribution of \dobs\ $\pf(x \| \yI)$ for it. The raw moments of this
distribution are
\begin{equation}
  \label{eq:raw_moments}
\E(x^m \| \yI) \defd  \sum_x x^m\;\pf(x \| \yI).
\end{equation}

Now think of $x$ as the number of units, among a total population of $N$,
that have some property. We can ask how many distinct \emph{ordered} pairs,
triplets, $m$-tuples have that property. Their number is the falling
factorial
\begin{equation}
  \label{eq:falling_factorial}
  x^{\underline{m}} \defd m!\,\binom{x}{m}.
\end{equation}
The $m$th factorial moment of our distribution is
\begin{equation}
  \label{eq:factorial_moments}
  \E(x^{\underline{m}} \| \yI) \equiv
  m!\,\E\condt*{\binom{x}{m}}{\yI} 
  \defd  m!\,\sum_x \binom{x}{m}\;\pf(x \| \yI).
\end{equation}
The expectation of the number of distinct \emph{unordered} $m$-tuples,
$\binom{x}{m}$, is therefore $1/m!$ times the $m$th factorial moment.

The total number of possible unordered $m$-tuples is $\binom{N}{m}$. The
fraction of unordered $m$-tuples having the property under study is
therefore $\binom{x}{m}/\binom{N}{m}$, and its expectation is the
normalized factorial moment
\begin{equation}
  \label{eq:normalized_factorial_moments}
\E\cond*{\frac{x^{\underline{m}}}{N^{\underline{m}}}}{\yI} 
\equiv \E\condt*{\frac{\binom{x}{m}}{\binom{N}{m}}}{\yI}.
\end{equation}
for $m=1$ we have the population mean $\E(x/N\|\yI)$ as a special case.

The use of factorial moments is useful because of their relation with raw moments:
\begin{equation}
  \label{eq:relation_factorial_raw_moments}
  \E(x^m\| \yI) = \sum_{n=0}^{m}\genfrac\{\}{0pt}{}{m}{n}\;\E(x^{\underline{n}}  \|\yI),
\end{equation}
where $\genfrac\{\}{0pt}{}{m}{n}$ is a Stirling number of the second kind \citep{knuth1992}.
