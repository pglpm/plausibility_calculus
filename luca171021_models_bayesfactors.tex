...
%% Last-Updated: 2019-01-04T01:10:00+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
A learning model $\yM$is one that yields different plausibilities about some
data $(y_1, y_2, \dotsc)$ conditional on $(x_1, x_2, \dotsc)$ if we add
knowledge about other data $(y_1', y_2', \dotsc)$, $(x_1', x_2', \dotsc)$:
\begin{multline}
  \label{eq:learning_def}
  \pf(y_1, y_2, \dotsc \| x_1, x_2,\dotsc,\, y_1', y_2', \dotsc,
  \, x_1', x_2',\dotsc,\, \yM) \ne{}\\
  \pf(y_1, y_2, \dotsc \| x_1, x_2,\dotsc,\, \yM)
\end{multline}
