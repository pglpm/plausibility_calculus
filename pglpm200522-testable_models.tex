...
%% Last-Updated: 2020-05-24T22:42:30+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\propertitle}{Testable and untestable models [draft]%\\{\large ***}%
...
\enquote{It's just a matter of terminology}, some may say. I want to argue
that it is related to something much more important: the
\emph{verifiability} of a hypothesis or model. I mean the following.
