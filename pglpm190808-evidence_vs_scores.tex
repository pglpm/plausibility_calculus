...
%% Last-Updated: 2019-08-12T23:46:59+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
belief in it conditional on all possible subsets of remaining data, from
the empty subset with no data (term $k=0$), to the only subset $D_{-i}$
with all data except $D_{i}$ (term $k=d-1$). These beliefs are averaged over
