...
%% Last-Updated: 2020-05-20T17:43:39+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
The last remark is strikingly true for so-called \enquote{composite
  hypotheses} \citep[\cf][\sect~6.1.4 p.~391]{bernardoetal1994_r2000},
having the form $\yHc \defd H_{1} \lor \dotsb \lor H_{m}$. An example is
the hypothesis \prop{the long-run relative frequency of heads is less than
  0.4}. The probabilities of the data conditional on a composite hypothesis
depend much more strongly on the context than the probabilities conditional
on the individual hypotheses do. This happens because, for any data $D$,
\begin{multline}
  \label{eq:comp_hyp}
...
paradox \citep{lindley1957} seems to be an example of this
misunderstanding.
