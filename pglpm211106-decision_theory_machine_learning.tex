...
%% Last-Updated: 2021-11-16T14:01:48+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
Formula~\eqref{eq:argsup_choice} presents several noteworthy points:
...
\item\label{item:utility_vs_inference} There is a utility part
  ...
  \emph{choice}\citep[\enquote{When we discuss model comparison, this
    should not be construed as implying model \emph{choice}}][\sect~28.1
  p.~347]{mackay1995_r2005}, so there is no real conflict.
