...
%% Last-Updated: 2019-09-02T14:54:20+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\item The software doesn't have the ability to take into account new data
  ...
  particular \emph{non-learning} model among those constituting our two
  learning models (the latter are a convex combinations of the former).
\item The software doesn't have the ability to take into account new data
  that the clinician acquires during its actual use, and we must choose one
...
\begin{multline}
  ...
  \propto{}\\
  \begin{aligned}[b]
  \p( \Kt \| \yx,\; \hh,\; \Xp,\; \Xt,\; \Ks,\; \Ki)& \times{}\\
  \p( \yx\| \hh,\; \Xp,\; \Xt,\; \Ks,\; \Ki)& \times{}\\
  \p(  \hh \|\Ks,\; \Ki).&
  \end{aligned}
\end{multline}
...
\begin{empheq}[box=\widefbox]{equation}
  ...
  \p( \yx\| \hh,\; \Xp,\; \Xt,\; \Ks,\; \Ki)
\end{empheq}
is what our software must provide. This expression answers the questions
that we asked in our scenario:
\begin{itemize}
\item If our software can learn from data acquired during its use, they
  enter the expression above. If it can't learn, it means that $\Xp$ above
  is simply unavailable and therefore drops out of the expression.
\item 
\end{itemize}
