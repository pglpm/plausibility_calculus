...
%% Last-Updated: 2019-09-02T12:28:09+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
We have to prepare and deliver such software, using two possible parametric
learning models to build it and some data, consisting in pairs of \fmri\
recordings and health conditions, to train it.

There are three possible sub-scenarios:
\begin{enumerate}[label=(S\arabic*)]
\item The software doesn't have the ability to update its decisions based
  on new data the clinician acquires during its actual use, and we must 
  choose one particular \emph{non-learning} model among those constituting
  our two learning models (the latter are a convex combinations of the
  former).
\item The software doesn't have the ability to update its decisions based
  on new data the clinician acquires during its actual use, and we must 
  choose one of the two learning models, which will be used in its final
  state of training.
\item The software will be able to update its decisions based on new data
  the clinician acquires during its use. We must still choose one of the
  two learning models.
\end{enumerate}
...
similar factors. She will order some tests, including the \fmri\ scan. She
will also have background knowledge about schizophrenia and also a
statistics of the subjects she examined in the past. Let's denote groups of
these pieces of information symbolically:
\begin{subequations}
  \begin{align}
    ...
    \\
    \Dt &\defd \parbox[t]{0.75\columnwidth}{\small results from tests, excluding \fmri}
    \\
