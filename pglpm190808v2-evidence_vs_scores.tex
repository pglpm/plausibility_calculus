...
%% Last-Updated: 2020-05-17T00:24:05+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
probability of the data given the hypothesis, $\p(D \| H \land \yK)$ --
also called the \emph{likelihood} for the hypothesis given the data
\citep[\sect~6.1 p.~62]{good1950}:
\begin{equation}
...
hypothesis for further use, discarding the others\citep[\sects~3.4, 6.1.6
gives the clearest motivation and explanation]{bernardoetal1994_r2000}[see
