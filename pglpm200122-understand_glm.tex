...
%% Last-Updated: 2020-01-22T11:53:07+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\epigraph{\emph{Where do probability models come from? To judge by the
    ...
    theoretician is happy to accept that his abstract \textins{model} % probability triple
    % {$(\Omega, \mathcal{A}, \mathcal{P})$}
    was found under a gooseberry
    bush, while the applied statistician's model ``just growed''.} }{A. P.
  Dawid \parencites*[\sect~4, p.~220]{dawid1982}}
