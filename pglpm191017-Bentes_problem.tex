...
%% Last-Updated: 2019-11-08T15:22:24+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\item \label{item:step_calculate_probabilities} Use the probability
  ...
  elementary statements of step~\ref{item:step_joint_prob}, the probability
  \begin{equation}
...
\subsection{Step 1: elementary statements}
...
whether they're true or false. But they serve us well as elementary
statements: we can precisely formulate our questions and data in terms of
them.
...
same under exchanges of the indices $i$ having the same values. For example:
\begin{multline}
