...
%% Last-Updated: 2020-05-30T18:01:28+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\begin{equation}
  ...
  N F_{x} \defd \tsum_{i}\delt(x, x_{i}), \quad x \in \sX \;.
\end{equation}

\bigskip

I will state the definition of partial exchangeability and its theorem in a
slightly unusual form, according to the discussion of
\sect~\ref{sec:inf_exch}, making clear the role of the additional
information about the category to which each instance belong.
