...
%% Last-Updated: 2019-01-05T20:43:38+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
In the rest of this note I intend \enquote{model} in the sense above,
including as special cases parametric models with a specific choice of
parameter. 
...
In fact, our first question is: what are we actually choosing in a
