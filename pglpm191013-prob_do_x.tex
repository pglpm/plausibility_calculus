...
%% Last-Updated: 2019-10-13T12:15:01+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\firstdraft}{13 October 2019}
\newcommand*{\firstpublished}{13 October 2019}
\newcommand*{\updated}{\ifarxiv 13 October 2019\else\today\fi}
\newcommand*{\propertitle}{Probability notation and causality\\{\large a comment on Pearl's \enquote{$\textit{do}(x)$}}%
}% title uses LARGE; set Large for smaller
\newcommand*{\pdftitle}{\propertitle}
\newcommand*{\headtitle}{Probability notation and causality}
...
\begin{abstract}\labelsep 0pt%
  \noindent A comment on probability theory, causality, and Pearl's
  notation \enquote{$\pdo(x)$}.
