...
%% Last-Updated: 2019-08-12T15:33:56+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
p.~62]{good1950}. The likelihoods of several hypotheses are often compared,
through their ratios for example, called \emph{relative Bayes factor}, or
its logarithm, called \emph{relative weight of evidence}
...
\begin{innote}
  I'd like to point out that the (non-relative) Bayes factor for a
  hypothesis $H_{h}$ provided by data $D$ is actually defined as
  \citep[\sect~2]{good1981}
  \begin{equation}
...
\sum_{h'}^{h' \ne h} \p(D \| H_{h'} \; \yK) \; \p(H_{h'} \| \yK)
  ...
  don't enjoy. For example, the  \citep[\sect~6.7]{good1950}
\end{innote}
...
called  and \emph{Bayes factor}
 I'm here speaking of the
