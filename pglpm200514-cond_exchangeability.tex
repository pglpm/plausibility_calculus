...
%% Last-Updated: 2020-05-31T21:43:28+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
$\set[\big]{\C{i}\=\cc{i}}$ is expressed by a fully exchangeable marginal
...
exchangeable distribution. Thus the joint distribution for the \emph{pairs}
of statements $\set[\big]{(\x{i}, \cc{i})}$ is fully exchangeable.
...
expresses the partial or conditional exchangeability for
$\set{\X{i}\=\x{i}}$ given $\set{\C{i}\=\cc{i}}$.
...
The density
$\pf\cond[\big]{\fxc}{I}\, \pf\cond[\big]{\fc}{I}\, \,\di\fxc\, \di\fc$ is
just a special case of a density over the joint frequencies,
$\pf\cond[\big]{\fj}{I}\, \,\di\fj$, since the variables $(\fxc,\fc)$ are in
