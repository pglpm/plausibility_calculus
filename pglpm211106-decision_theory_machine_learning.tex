...
%% Last-Updated: 2021-11-06T20:59:53+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\end{equation}
which, using \eqns~\eqref{eq:total_utility} and
\eqref{eq:exchangeable_prob}, becomes
\begin{equation}
  \label{eq:exp_utility_replace}
  E(\theta \| \bz, H) 
=\iiint \sum_{n} u(\theta \| \yx{n}\yy{n}) \
...
\begin{equation}
  ...
  \begin{split}
  E(\theta \| \bz, H) 
&= \sum_{n} \iiint u(\theta \| \yx{n}\yy{n}) \
    F(\yx{n}\yy{n}) \ \p(F \| \bzz, H)\ \di\bz\,\di F
\\&\propto \iiint u(\theta \| xy) \
