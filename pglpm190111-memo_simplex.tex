...
%% Last-Updated: 2019-07-31T14:49:08+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\end{equation}
the $N$-dimensional simplex, or $N$d-simplex, which can be thought of as
...
Let's examine some geometric properties of the $N$d-simplex, embedded as a
...
\item the ratio of the radii of circum- and in-hypersphere is $N$,
  ...
  hypervolume of the $N$d-simplex is \enquote{at the corners};
...
The simplex can be naturally embedded in
