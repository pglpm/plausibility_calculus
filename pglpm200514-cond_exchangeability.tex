...
%% Last-Updated: 2020-06-02T00:00:26+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
The first result is a reformulation of partial exchangeability and its
representation theorem in a slightly unfamiliar form. Though not
remarkable, this reformulation gives some insights into the connection
between partial and conditional exchangeability, and their connection to
regression.

The second result is an integral representation for joint probability
distributions with particular symmetries: some of the conditional
distributions obtained from them satisfy partial exchangeability. This
integral representation has the usual de~Finetti form but, remarkably, its
density factorizes in a special way. This factorization expresses the
conditional-exchangeability symmetries.

The third result brings together exchangeability and Bayesian networks. It
is an integral representation for repetitions of phenomena or experiments
whose conditional dependences and independences are described by a Bayesian
network. This representation is, so to speak, a mixture of copies of the
same Bayesian network -- analogously to de~Finetti's representation, which
is a mixture of independent probability distributions (\enquote{i.i.d.}).
...
Each of these three results builds on the preceding ones. They are
presented in the next three sections. The final section discusses them
further and hints at possible applications for them.
