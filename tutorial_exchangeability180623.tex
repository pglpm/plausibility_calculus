...
%% Last-Updated: 2019-03-01T00:23:32+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
ensembles, maximum-entropy models, relative entropy, unsupervised learning,
parametric and non-parametric models, can be said to originate from
exchangeable models. The understanding of these models therefore gives us a
unified view of a variety of topics and of their connections.

Many scientists probably use them routinely without knowing the technical
name \enquote{exchangeable model}, and possibly without knowing about their
important properties. This ignorance is mainly caused by a language
barrier: most literature on exchangeable models uses very specialized
language strongly connected with topology, measure theory, differential
geometry, and other subjects that are usually superficially touched in the
teaching of other sciences. Such subjects are of course necessary for a
precise foundation of exchangeable models and other probabilistic notions.
Yet, many technical concepts underlying the probability calculus have a
very intuitive and even visual meaning at bottom.
...
The present notes try to present exchangeable models and many notions
related to them in an intuitive and visual way.
