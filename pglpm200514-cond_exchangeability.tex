...
%% Last-Updated: 2020-05-15T00:22:46+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\propertitle}{On partial and conditional exchangeability[draft]%\\{\large ***}%
...
\begin{abstract}\labelsep 0pt%
  \noindent A formula is given connecting the representation of partial and
