...
%% Last-Updated: 2020-05-18T17:25:29+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
The intuition behind this score can be colloquially expressed thus:
\enquote{let's see what my belief in one datum would be, on average, once
  I've observed the other data, if I consider $H$ as true}.  Bernardo \amp\
Smith\citep[\sect~6.1.6]{bernardoetal1994_r2000} give an informal but
deeper and interesting motivation for this score, basing it in
the principles of probability theory and decision theory.
