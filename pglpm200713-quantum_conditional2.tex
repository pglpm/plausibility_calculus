...
%% Last-Updated: 2020-07-14T13:03:46+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\item It \emph{does} matter whether many photons are sent at once, or one
  at a time, as well as their wavelength and temporal spread. These details
  lead to different probabilities distributions of detection at the screen
  depend on the spatio-temporal form of the electromagnetic field,
\end{enumerate}
