...
%% Last-Updated: 2019-08-02T12:57:21+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
expression~\eqref{eq:normal}, though, if it's expressed in affine
coordinates; that is, if $\yq$ is represented by an $(N+1)$-tuple summing up
to one and the formula is conceived in the positive orthant.
