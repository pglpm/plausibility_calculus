...
%% Last-Updated: 2019-01-09T23:59:17+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
health conditions or diseases are more frequent among individuals that have
particular variants of pieces of \textsc{dna}
(\textsc{s}ingle-\textsc{n}ucleotide \textsc{p}olymorphisms). This means
that we could use this genetic information to make better guesses on
whether a person has or will develop a particular disease. Our uncertainty
come from the small size of our samples: we'd like to guess what are the
conditional frequencies of the disease given the \snp\ variants in the full
population. Many studies face this kind of association in a dichotomous
way: \enquote{is this particular \snp\ associated with that disease? yes or
  no?} But the association isn't dichotomous: there is a continuum of
differences between the conditional frequencies of the disease conditional
on the \snp\ variants. The question is: how do we want to use this
association? what choices do we need to make? If the idea is to take a
genetic sample for diagnostics, the issue could be that the cost and time
involved allow us to check, say, only five \snp s in an individual. Then
our decision problem is to choose five \snp s to be used in the automated
diagnostics.
