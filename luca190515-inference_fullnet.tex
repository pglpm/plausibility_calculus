...
%% Last-Updated: 2019-10-29T15:50:10+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
multiplicity~\eqref{eq:multinomial_coefficient_withinrow_approx} above. We
find
\begin{equation}
...
in exponential-logarithm form. Finally, we note that $G_{a\,A}\,\nu_{A}$ is
a normalized distribution in $(a,A)$ owing to the properties of the
hypergeometric distribution and of $\ynu$, and we use the definition of
relative entropy
\begin{equation}
...
of our joint density~\eqref{eq:joint_q_J_almost-final} can finally be
written as
\begin{empheq}[box=\widefbox]{equation}
  \label{eq:log-density_final}
  \ln \pf(\yJ, \ynu \| \yas, \yI) = \ln q(\ynu)
  -T\,\ysh\bigl[\yJ; (G_{a\,A}\,\nu_{A})\bigr]
  - T\,\ysh(\yf) - \ln Z(\yas)
\end{empheq}
...
be discarded in Monte Carlo sampling.
