...
%% Last-Updated: 2025-09-09T22:08:31+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\reporthead}{\ifarxiv\else\zenododoi{10.5281/zenodo.17072200}\fi}% Report number
...
\begin{abstract}\labelsep 0pt%
  \noindent A curious information-theoretic property of 89\% credibility intervals is discussed.
...
A \emph{credibility interval} (or \enquote{credible}, \enquote{Bayesian}, \enquote{posterior}, \enquote{compatibility} interval or region) is a range where the true value of some real quantity lies with a given probability \autocites[\sect~5.1.5 pp.~259ff]{bernardoetal1994_r2000}. For instance, if $\clcl{1.2, 7.0}$ is a 60\% credibility interval for the quantity $Q$, then there is a 60\% probability that the true value of $Q$ is between $1.2$ and $7.0$ (note the difference in meaning from a \emph{confidence} interval, whose definition is much more involved and less direct \autocites[\sect~37.3]{mackay1995_r2005}{jaynes1976}). It is always best to report the full posterior probability distribution of a quantity of interest, so that the reader can calculate from it the probabilities of any desired ranges and make decisions \autocites{raiffa1968_r1970}. But credibility intervals often provide useful summaries of the full distribution.

Credibility intervals of 50\%, 75\%, 90\%, 95\%, or even 99\% probability are more or less commonly used in the Bayesian literature and given as defaults in software packages for Bayesian analysis. Also \emph{89\%} ones have become quite fashionable since around 2016; they seemingly originate in McElreath's \emph{Statistical Rethinking} \autocites{mcelreath2016_r2020}, first published in that year. They are used, for example, in the software package \emph{bayestestR} \autocites{makowskietal2019}. McElreath justly points out\autocites[\eg\ \sect~3.2.2 p.~56, \sect~4.3.5 p.~88]{mcelreath2016_r2020} that the specific probability value of a credibility interval should be chosen depending on the context; there is nothing special about values like 90\% or 95\%. To emphasize and remind us of this fact (and also to avoid confusion with confidence intervals, whose meaning is different) he uses 89\%, which is an arbitrary value.

Or is it?

It turns out that 89\% credibility intervals do possess a curious information-theoretic property, which may also motivate the use of 50\% and 89\% as defaults.
...
When we report a 50\% and an 89\% credibility interval we are therefore reporting intervals having uncertainties of one shannon and of half a shannon. Of course the arbitrariness remains.
% We could also report intervals with uncertainties \qty{1}{Sh}, $\frac23\:\unit{Sh}$, $\frac13\:\unit{Sh}$; their credibilities would be $50\%$, $82.6\%$, $93.9\%$. Or with uncertainties \qty{1}{Sh}, \qty{0.5}{Sh}, \qty{0.25}{Sh}, corresponding to $50\%$, $89.0\%$, $95.8\%$.
