...
%% Last-Updated: 2019-01-10T15:07:09+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
particular disease. Our uncertainty comes from the small size of our
...
the disease conditional on the \snp\ variants. The questions we need to
answer are: how do we want to use this association? what choices do we need
to make? Suppose that the idea is to examine a person's \snp s to diagnose
the disease, in an automated way. However, the cost and time involved allow
us to check, say, only one \snp. Our decision problem is to choose the
\snp\ to be used in the automated diagnostics. For simplicity assume that
the candidate \snp s have only two variants each. The gain in using a
