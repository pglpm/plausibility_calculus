...
%% Last-Updated: 2021-11-06T20:22:45+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
We adopt this general point of view, and later explore how the separation
into two different kinds of choices is made. Our possible choices or
decisions therefore consist of the possible values $\theta \in \varTheta$.
...
$u(\theta \| \yx{n}\yy{n})$ depends on the specific problem -- it is in
fact no less problem-specific than the choice of \ml\ algorithm -- so we do
not make any assumptions about it for the moment.
...
Analogously to the scenarios we denote
