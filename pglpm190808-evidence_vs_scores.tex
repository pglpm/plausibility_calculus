...
%% Last-Updated: 2019-08-18T19:04:39+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\pdftitle}{A relation between log-likelihood and cross-validation log-scores}
...
\begin{acknowledgements}
  ...
  Mari, Miri, Emma for continuous encouragement and affection, and to Buster
