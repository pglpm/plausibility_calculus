...
%% Last-Updated: 2025-09-06T11:23:25+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
Credibility intervals of 50\%, 75\%, 90\%, 95\%, or even 99\% probability are more or less commonly reported in the Bayesian literature. Since at least 2016 also \textbf{89\%} credibility intervals have become quite fashionable. They seem to originate in McElreath's \emph{Statistical Rethinking} \parencites*{mcelreath2016_r2020}, first published in that year. McElreath rightly points out that any specific probability value is arbitrary; a value should be chosen depending on the context. To emphasize and remind us of this fact, he uses 89\%, which is an arbitrary value.

Or so he thought.

It turns out that 89\% credibility intervals possess a special property.
...
The result of a Bayesian inference about some quantity of interest is usually a full probability distribution over the possible values of that quantity. From such a distribution the reader can then, for instance, make decisions by combining the distribution with appropriate utilities; this includes the decision on which value should be reported, if a unique answer (\enquote*{estimate}) is required.

But it is often useful to pro

\autocites[\sect~3.2.2 p.~56]{mcelreath2016_r2020}
